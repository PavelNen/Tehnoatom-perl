...
INSERT INTO `favorites` VALUES (8,2,'1,5,3,'),(9,1,'5,2,6,3,'),(10,6,'5,2,3,1,'),(11,3,'5,6,2,'),(12,7,''),(13,5,'2,');
...
INSERT INTO `notes` VALUES (7,2,'Одиночество','В беспрерывном одиночестве ум становится все острее. Для того, чтобы думать и изобретать не нужна большая лаборатория. Идеи рождаются в условиях отсутствия влияния на разум внешних условий. Секрет изобретательности в одиночестве.\r\nВ одиночестве рождаются идеи.','2017-05-22 16:57:49','ALL,','w',''),(9,1,'Не понятно','Не понятно, как передать, нажав по ссылке,\r\nпараметр','2017-05-22 16:57:49','','r',''),(10,1,'Тесла','Эта заметка должна быть видна только Николе Тесле','2017-05-22 16:57:49','2,','r',''),(12,2,'Проверка доступности','Эта заметка видна Павлу и Тому.','2017-05-22 16:57:49','tomkruzzz,pavelnen,','r',''),(29,2,'Студентам','Не будет большим злом, если студент впадет в заблуждение; если же ошибаются великие умы, мир дорого оплачивает их ошибки.','2017-05-22 16:57:49','ALL,','r',''),(38,5,'','Что я уважаю в людях, так это естественность и подлинность. Мне нравится смотреть в душу. Я стремлюсь быть честным человеком.','2017-05-22 16:57:49','ALL,','r',''),(39,5,'О Чёрной Вдове','Этот персонаж развивался с годами и позволял развиваться мне самой. К тому же это очень загадочная героиня с удивительным прошлым, что давало мне немало возможностей для работы.','2017-05-22 16:57:49','ALL,','r',''),(40,5,'Не жди','Если в твоей жизни затишье и ты не знаешь, что делать, — жди. Но не жди слишком долго, а если ждёшь слишком долго — делай что-нибудь.','2017-05-22 17:28:44','ALL,','r','blackwidow, '),(41,2,'Природа','Общение с природой укрепило моё тело и разум.\r\nUPD. отредактировано pavelnen!','2017-05-22 17:21:51','ALL,','w','nikolatesla, pavelnen, blackwidow, '),(42,1,'Хокку','Воскресенье.\r\nПоявляются заметки.\r\nХороший сайт.','2017-05-22 16:57:49','ALL,','r',''),(43,1,'CSRF_protection','Сайт должен быть\r\nзащищён от\r\nхакеров','2017-05-22 16:57:49','','r',''),(44,1,'Заметка','Привет, Саня','2017-05-22 16:57:49','','r',''),(45,1,'Длинные слова','«Тетрагидропиранилциклопентилтетрагидропиридопиридиновые»\r\n«Гидразинокарбонилметилбромфенилдигидробенздиазепин»','2017-05-22 16:57:49','6,5,2,','r','');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Пользователи соцсети';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-05-22 20:45:39
